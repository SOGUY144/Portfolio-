  ...
  return (
    <section id="portfolio" style={{ maxWidth: '1200px', margin: '0 auto', padding: '100px 5%', position: 'relative', zIndex: 10 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h2 style={{ fontSize: '3.5rem', fontWeight: '800', color: '#fff', margin: '0 0 1rem 0' }}>Portfolio Showcase</h2>
        <p style={{ color: '#94a3b8', fontSize: '1.1rem' }}>Explore my journey through projects, certifications, and technical expertise.</p>
      </div>
              ...
              {content.projects.map(proj => (
                <div key={proj.id} style={{ 
                  ...
                  <div style={{ padding: '2rem' }}>
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '0.95rem', lineHeight: '1.6', marginBottom: '1.5rem' }}>{proj.success}</p>
                    <button style={{ 
                      background: 'rgba(255,255,255,0.1)', border: 'none', padding: '0.8rem 1.5rem', borderRadius: '50px', color: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', transition: 'background 0.3s ease'
            ...
            >
              {content.certificates.map(cert => (
                <div key={cert.id} style={{ 
                  ...
                  <div style={{ 
                    height: '250px', background: '#0f172a', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.05)' 
                  }}>
                    <span style={{ color: '#334155' }}>[Certificate Image]</span>
                  </div>
                  <div style={{ padding: '1.5rem 1rem 0.5rem 1rem', textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#38bdf8', fontSize: '0.9rem', margin: 0, textTransform: 'uppercase', letterSpacing: '1px' }}>{cert.issuer} • {cert.date}</p>
                  </div>
                </div>
              ))}
            </motion.div>
